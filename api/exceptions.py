...
class VideoProcessingIncompleteError(APIException):
    ...
    def __init__(self, request_id: str, current_status: str, message: Optional[str] = None):
...
class VideoProcessingFailedError(APIException):
    ...
    def __init__(self, request_id: str, failure_reason: Optional[str] = None, message: Optional[str] = None):
...
class SearchServiceError(APIException):
    ...
    def __init__(self, message: str, search_method: str, details: Optional[Dict[str, Any]] = None):
