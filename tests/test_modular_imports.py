...
def test_direct_module_imports():
    ...
    from telemetry.exceptions import VideoProcessingError
    print("✅ Direct exceptions import works!")
    
    # Test resilience module
    from telemetry.resilience import circuit_breaker
...
def test_unified_telemetry_imports():
    ...
    from telemetry import get_logger, TimingContext, log_memory_usage, VideoProcessingError, circuit_breaker
...
def test_backward_compatibility():
    ...
    from telemetry.utils import get_logger, TimingContext, log_memory_usage, VideoProcessingError, circuit_breaker
