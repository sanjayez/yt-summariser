...
class UnifiedProcessRequestSchemaTest(TestCase):
    ...
    def test_valid_topic_request(self):
        ...
        data = {"content": "python machine learning tutorial", "type": "topic"}
    ...
    def test_video_url_validation_non_http(self):
        ...
        data = {"content": "ftp://example.com/video", "type": "video"}
    ...
    def test_content_whitespace_stripping(self):
        ...
        data = {"content": "  python machine learning  ", "type": "topic"}
    ...
    def test_schema_json_examples(self):
        ...
        examples = UnifiedProcessRequest.model_config.get("json_schema_extra", {}).get(
            "examples", []
        )
...
class UnifiedProcessResponseSchemaTest(TestCase):
    ...
    def test_missing_session_id(self):
        ...
        data = {"status": "processing", "remaining_limit": 2}
    ...
    def test_invalid_remaining_limit_type(self):
        ...
        errors = context.exception.errors()
        remaining_limit_errors = [
            error for error in errors if error["loc"] == ("remaining_limit",)
        ]
    ...
    def test_schema_json_examples(self):
        ...
        # Get examples from schema config
        examples = UnifiedProcessResponse.model_config.get("json_schema_extra", {}).get(
            "examples", []
        )
