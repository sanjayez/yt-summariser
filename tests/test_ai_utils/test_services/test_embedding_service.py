...
from ai_utils.models import BatchEmbeddingResponse, EmbeddingResponse, ProcessingStatus
...
class TestEmbeddingService:
    ...
    def mock_provider(self):
        ...
        from ai_utils.models import BatchEmbeddingResponse, EmbeddingResponse
        ...
        provider.get_supported_models = lambda: [
    ...
    def service(self, mock_provider, mock_config):
        ...
        with pytest.MonkeyPatch().context() as m:
            m.setattr(
                "ai_utils.services.embedding_service.get_config", lambda: mock_config
            )
    ...
    async def test_embed_text_with_custom_model(self, service):
        ...
        await service.embed_text("Hello world", model="text-embedding-3-large")
    ...
    async def test_embed_documents_custom_fields(self, service):
        ...
        result = await service.embed_documents(
            documents, text_field="content", id_field="doc_id"
        )
