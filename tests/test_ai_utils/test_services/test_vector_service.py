...
from ai_utils.models import (
    ...
    IndexConfig, IndexStats, ProcessingStatus
)
...
class TestVectorService:
    ...
    def mock_provider(self):
        ...
        from ai_utils.models import VectorSearchResponse, VectorSearchResult, IndexConfig, IndexStats
        ...
        provider.get_supported_metrics.return_value = ["cosine", "euclidean", "dotproduct"]
    ...
    def service(self, mock_provider, mock_config):
        ...
        with pytest.MonkeyPatch().context() as m:
            m.setattr("ai_utils.services.vector_service.get_config", lambda: mock_config)
    ...
    async def test_upsert_documents_with_job_tracking(self, service):
        ...
        job_id = "test_job_123"
        result = await service.upsert_documents(documents, job_id=job_id)
    ...
    async def test_delete_documents_with_job_tracking(self, service):
        ...
        result = await service.delete_documents(document_ids, job_id=job_id)
