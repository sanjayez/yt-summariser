...
from ai_utils.models import VectorDocument, VectorQuery, VectorSearchResponse, IndexConfig, IndexStats
...
class TestPineconeVectorStoreProvider:
    ...
    def provider(self, mock_config, mock_pinecone_client):
        ...
        with patch('ai_utils.providers.pinecone_store.Pinecone', return_value=mock_pinecone_client):
    ...
    async def test_get_document_not_found(self, provider):
        ...
        provider.provider._get_index.return_value.fetch.return_value = mock_fetch_response
