...
class TestEmbeddingModels:
    ...
    def test_batch_embedding_request_valid(self):
        ...
        request = BatchEmbeddingRequest(
            texts=["Hello", "World", "Test"], model="text-embedding-3-small"
        )
...
class TestVectorModels:
    ...
    def test_vector_document_empty_id(self):
        ...
        with pytest.raises(ValueError, match="Document ID cannot be empty"):
            VectorDocument(id="   ", text="Sample text", embedding=[0.1, 0.2, 0.3])
...
class TestRAGModels:
    ...
    def test_rag_query_valid(self):
        ...
        query = RAGQuery(query="What is AI?", top_k=5, temperature=0.7, max_tokens=100)
...
class TestProcessingModels:
    ...
    def test_processing_job_valid(self):
        ...
        job = ProcessingJob(
            job_id="job_123", operation="embedding", total_items=100, processed_items=50
        )
