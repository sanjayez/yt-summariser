...
def youtube_resilient[F: Callable[..., any]](func: F) -> F:
...
def openai_resilient[F: Callable[..., any]](func: F) -> F:
    return resilient_external_call(
...
def vector_store_resilient[F: Callable[..., any]](func: F) -> F:
    return resilient_external_call(
...
def database_resilient[F: Callable[..., any]](func: F) -> F:
    return resilient_external_call(
...
def web_scraping_resilient[F: Callable[..., any]](func: F) -> F:
    return resilient_external_call(
...
def filesystem_resilient[F: Callable[..., any]](func: F) -> F:
...
def cache_resilient[F: Callable[..., any]](func: F) -> F:
    return resilient_external_call(
        service_name="cache",
        max_attempts=2,
        timeout_seconds=5.0,
