...
class PerformanceMonitor:
    ...
    def record_metric(self, operation: str, metrics: PerformanceMetrics) -> None:
        ...
        self.logger.debug(
            f"Recorded metrics for {operation}: {metrics.to_dict()}"
        )
            ...
            try:
                ...
                with monitor.monitor(func.__name__) as metrics:
                    ...
                    metrics.additional_metrics.update({
                        ...
                        'exceeded_memory_threshold': final_stats['memory']['percent'] > threshold_memory_percent,
                        'exceeded_cpu_threshold': final_stats['cpu']['total_percent'] > threshold_cpu_percent
                    })
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                if gc.isenabled():
                    ...
                    func_logger.debug(
                        f"GC counts after {func.__name__}: {gc_stats}"
                    )
...
def log_function_resources(func: F) -> F:
    """
...
def get_process_info() -> Dict[str, Any]:
    ...
    try:
        ...
        info['num_handles'] = process.num_handles() if hasattr(process, 'num_handles') else None
