...
class EmbeddingService:
    ...
    async def embed_text(
        ...
        try:
            ...
            self.stats["embedding_tokens"].append(response.usage.get("prompt_tokens", 0))
    ...
    async def embed_batch(
        ...
        try:
            ...
            self.stats["batch_embedding_tokens"].append(batch_response.usage.get("prompt_tokens", 0))
