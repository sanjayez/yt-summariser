...
class QueryEnhancementService:
    ...
    async def enhance_query(self, original_query: str) -> Tuple[List[str], List[str], str]:
        try:
            ...
            try:
                ...
                logger.info(f"LLM enhancement successful: {len(enhanced_queries)} queries, intent: {intent_type}")
