...
class AIKnowledgeBase:
    ...
    async def initialize(self):
        ...
        for i, (service, health) in enumerate(zip(services, health_results)):
        ...
        if not all_healthy:
            raise Exception("Some services are not healthy. Please check your configuration.")
    ...
    async def populate_knowledge_base(self):
        ...
        documents = [
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "beginner", "topic": "fundamentals"}
            },
            {
                ...
                "metadata": {"category": "neural_networks", "difficulty": "intermediate", "topic": "architecture"}
            },
            {
                ...
                "metadata": {"category": "deep_learning", "difficulty": "intermediate", "topic": "advanced_ml"}
            },
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "beginner", "topic": "learning_types"}
            },
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "intermediate", "topic": "learning_types"}
            },
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "advanced", "topic": "learning_types"}
            },
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "intermediate", "topic": "model_evaluation"}
            },
            {
                ...
                "metadata": {"category": "machine_learning", "difficulty": "intermediate", "topic": "data_preprocessing"}
            },
            {
                ...
                "metadata": {"category": "deep_learning", "difficulty": "advanced", "topic": "computer_vision"}
            },
            {
                ...
                "metadata": {"category": "nlp", "difficulty": "advanced", "topic": "language_processing"}
            }
        ]
        ...
        try:
            ...
            logger.info(f"✅ Successfully stored {result['upserted_count']} documents in {result.get('processing_time_ms', 0):.1f}ms")
            return True
        ...
        for i, query in enumerate(search_queries, 1):
            try:
                ...
                for j, result in enumerate(search_result.results, 1):
                    logger.info(f"   {j}. Score: {result.score:.3f} | Category: {result.metadata.get('category', 'N/A')}")
    ...
    async def demonstrate_llm_capabilities(self):
        ...
        try:
            ...
            logger.info(f"   Generated {batch_result['total_processed']} responses in {batch_result['processing_time_ms']:.1f}ms:")
    ...
    async def demonstrate_rag_pipeline(self):
        ...
        for i, question in enumerate(rag_questions, 1):
            ...
            try:
                ...
                logger.info(f"   📚 Found {len(search_result.results)} context documents")
    ...
    async def demonstrate_intelligent_search(self):
        ...
        search_query = "I want to build a system that can recognize images. What should I learn?"
...
4. Additional resources to explore"""
            ...
            logger.info(f"🎯 Intelligent Search Result:")
            logger.info(f"{enhanced_result['text']}")
            logger.info(f"📊 Based on {len(search_result.results)} knowledge base documents")
    ...
    async def show_performance_statistics(self):
        ...
        try:
            ...
            logger.info(f"📈 Embedding Service:")
            ...
            if llm_stats.get('benchmark_stats'):
                ...
                for operation, metrics in llm_stats['benchmark_stats'].items():
                    if 'avg_ms' in metrics:
                        logger.info(f"   {operation}: avg {metrics['avg_ms']:.1f}ms ({metrics['count']} calls)")
