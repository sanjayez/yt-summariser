...
def example_search_only():
    ...
    # Start search task
    search_task = process_search_query.apply_async(args=[str(search_request.request_id)])
...
def example_parallel_processing():
    ...
    processing_task = process_search_results.apply_async(args=[str(search_request.request_id)])
