...
def demo_basic_search_request():
    ...
    print(f"Created search request:")
...
def demo_parallel_processing():
    ...
    workers = create_batch_workers(
        worker_count=parallel_config.max_workers,
        worker_id_prefix="video_processor"
    )
    ...
    throughput = calculate_throughput(
        completed=orchestration.completed_tasks,
...
def demo_full_integration():
    ...
    print(f"Main integration request:")
    ...
    main_response.aggregated_status.overall_progress = calculate_progress_percentage(1, 3)
...
def demo_status_checks():
    ...
    print(f"  Completed: {status_response.completed_videos}/{status_response.total_videos}")
...
def demo_serializer_integration():
    ...
    print(f"Original Pydantic model:")
    print(f"  Query: {search_request.query}")
    print(f"  Max Videos: {search_request.max_videos}")
