...
class ExplorerProgressTracker:
    ...
    def begin_expedition(self):
        ...
        self._publish(
            "expedition_start", {"message": "🚀 Explorer expedition starting..."}
        )
    ...
    def start_stage(self, stage_code):
        ...
        self._publish(
            "stage_start",
            {"stage": stage_code, "message": stage["message"], "progress": progress},
        )
    ...
    def complete_stage(self, stage_code, **format_vars):
        ...
        self._publish(
            "stage_complete",
            {"stage": stage_code, "message": completion_msg, "progress": progress},
        )
    ...
    def expedition_complete(self):
        ...
        self._publish(
            "complete", {"message": "🎉 Knowledge expedition completed successfully!"}
        )
